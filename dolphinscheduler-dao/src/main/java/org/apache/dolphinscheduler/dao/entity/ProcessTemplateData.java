...
/**
 * process template json data structure
 *
 * @author ArthurZhang
 * @since 2021-02-05
 */
public class ProcessTemplateData {
     ...
     */
    public ProcessTemplateData(List<TaskNode> tasks, List<Property> globalParams) {
        this.tasks = tasks;
    ...
    public boolean equals(Object o) {
        ...
        ProcessTemplateData that = (ProcessTemplateData) o;
