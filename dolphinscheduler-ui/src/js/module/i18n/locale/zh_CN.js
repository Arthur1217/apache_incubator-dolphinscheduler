...
export default {
  ...
  'Node name': '节点名称',
  'Business form url': '业务表单链接',
  'Please enter name (required)': '请输入名称(必填)',
  'Please enter global business form url (optional)': '请输入全局业务表单链接(选填)',
  'Please enter node business form url (optional)': '请输入节点业务表单链接(选填)',
  'Run flag': '运行标志',
  Normal: '正常',
  ...
  'Please enter app root url': '请输入应用根路径',
  'Owned Users': '所属用户',
  'Process Pid': '进程Pid',
  ...
  Create: '创建',
  'Create schedule': '添加定时',
  'Update schedule': '更新定时',
  ...
  'Create template': '创建流程模板',
  'Import process': '导入工作流',
  'Import template': '导入流程模板',
  'Timing state': '定时状态',
  Timing: '定时',
  TreeView: '树形图',
  ...
  'Process template details': '流程模板详情',
  'Create process definition': '创建流程定义',
  'Create process template': '创建流程模板',
  ...
  'There are no projects that have one or more process definitions': '未找到合适项目(关联一个以上流程定义)',
