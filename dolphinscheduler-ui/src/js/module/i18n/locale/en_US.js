...
export default {
  ...
  'Node name': 'Node name',
  'Business form url': 'Business form url',
  'Please enter name (required)': 'Please enter name (required)',
  'Please enter global business form url (optional)': 'Please enter global business form url (optional)',
  'Please enter node business form url (optional)': 'Please enter node business form url (optional)',
  'Run flag': 'Run flag',
  Normal: 'Normal',
  ...
  'Project Home': 'Application Home',
  'Project Manage': 'Application',
  ...
  'App Root Url': 'App Root Url',
  'Please enter name': 'Please enter name',
  'Please enter app root url': 'Please enter app root url',
  ...
  Start: 'Start',
  'Biz prop config': 'Business properties configure',
  Copy: 'Copy',
  'Copy name': 'Copy name',
  Delete: 'Delete',
  ...
  'Process template details': 'Process template details',
  ...
  'There are no projects that have one or more process definitions': 'There are no projects that have one or more process definitions',
