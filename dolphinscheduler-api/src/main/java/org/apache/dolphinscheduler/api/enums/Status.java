...
public enum Status {
    ...
    CREATE_PROCESS_TEMPLATE(10151,"create process template", "创建流程模板错误"),
    VERIFY_PROCESS_DEFINITION_NAME_UNIQUE_ERROR(10106,"verify process definition name unique error", "工作流定义名称已存在"),
    VERIFY_PROCESS_TEMPLATE_NAME_UNIQUE_ERROR(10149,"verify process template name unique error", "流程模板名称已存在"),
    UPDATE_PROCESS_DEFINITION_ERROR(10107,"update process definition error", "更新工作流定义错误"),
    UPDATE_PROCESS_TEMPLATE_ERROR(10150,"update process template error", "更新流程模板错误"),
    ...
    QUERY_DETAIL_OF_PROCESS_TEMPLATE_ERROR(10153,"query detail of process template error", "查询流程模板详细信息错误"),
    ...
    SET_LOCAL_RUNTIME_VARIABLE(10162,"set local runtime variable", "设置局部运行时变量错误"),
    ...
    GET_TASKS_LIST_BY_PROCESS_TEMPLATE_ID_ERROR(10156,"get tasks list by process template id error", "查询流程模板节点信息错误"),
    GET_TASKS_LIST_BY_PROCESS_TEMPLATE_ID_LIST_ERROR(10157,"get tasks list by process template id list error", "查询流程模板节点信息错误"),
    ...
    QUERY_PROCESS_TEMPLATE_LIST_PAGING_ERROR(10155,"query process template list paging error", "分页查询流程模板列表错误"),
    ...
    COPY_PROCESS_TEMPLATE_ERROR(10152,"copy process template error", "复制流程模板错误"),
    ...
    PROCESS_TEMPLATE_NOT_EXIST(50030, "process template {0} does not exist", "流程模板[{0}]不存在"),
    ...
    PROCESS_TEMPLATE_NOT_ALLOWED_EDIT(50034, "process template {0} does not allow edit", "流程模板[{0}]不允许修改"),
    ...
    DELETE_PROCESS_TEMPLATE_BY_ID_ERROR(50031,"delete process template by id error", "删除流程模板错误"),
    ...
    BATCH_DELETE_PROCESS_TEMPLATE_BY_IDS_ERROR(50033,"batch delete process template by ids {0} error", "批量删除流程模板[{0}]错误"),
    ...
    BATCH_EXPORT_PROCESS_TEMPLATE_BY_IDS_ERROR(50035,"batch export process template by ids error", "批量导出流程模板错误"),
    IMPORT_PROCESS_DEFINE_ERROR(50029,"import process definition error", "导入工作流定义错误"),
    IMPORT_PROCESS_TEMPLATE_ERROR(50032,"import process template error", "导入流程模板错误"),
